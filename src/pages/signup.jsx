    ...
    <div className=' flex flex-col justify-center items-center text-white'>
      <div className=' flex flex-col justify-center items-center '>
          ...
          <form className=' w-full  '>
              ...
              <div className='  w-full p-2 bg-[#433C62] rounded-xl my-3'>
              <input className='  bg-transparent text-black placeholder:text-[#D2D2D2]' type='password' placeholder='Re-enter password'/>
              </div>
              
              <div><p> have an account? <a href='/'>log in</a> </p></div>
              <div className='  w-[60%]  py-2 bg-[#7189FF] rounded-xl text-center my-3 mx-auto '>
              <button class="rounded-full mx-auto text-center">Sign up</button>
              </div>
          </form>
      </div>
    </div>
